...
- Planning: Complete
- Implementation: Phase 7 Preview 3 exact candidate and single hosted matrix verified; immutable tags and protected draft in progress
...
- Current active batch: Phase 7 Preview 3 immutable verification/signing tags, exact environment policy, protected draft, downloaded-asset verification, and final manual publication gate
