...
The authorized public preview candidate is `0.1.0-preview.2`. The repository `ImplementationPlan.md` is the authoritative live evidence record; package contents describe the gates without claiming the release exists before publication.
...
| Metadata | Manifest, changelog, archive, checksum, release notes, tag, and GitHub Release agree on `0.1.0-preview.2` |
...
| Signed tags | an additional Preview 2 verification tag and signed `v0.1.0-preview.2` peel to the exact hosted-tested candidate; GitHub marks the semantic tag signature Verified |
